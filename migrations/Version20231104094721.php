 ...
 */
final class Version20231104094721 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD CONSTRAINT FK_DA88B13712469DE2 FOREIGN KEY (dish_type_id) REFERENCES dish_type (id)');
        $this->addSql('CREATE INDEX IDX_DA88B13712469DE2 ON recipe (dish_type_id)');
    }
